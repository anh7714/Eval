          ...
          <Card className="krds-card">
            <CardContent className="p-4">
              ...
              <div className="space-y-2">
                <h3 className="text-xl font-bold text-gray-900">{progress?.progress || 0}%</h3>
                <Progress value={progress?.progress || 0} className="h-2" />
                <p className="text-sm text-gray-600">평가 완성도</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="krds-card">
            <CardContent className="p-4">
              ...
              <div className="space-y-1">
                <h3 className="text-xl font-bold text-gray-900">{progress?.completed || 0}</h3>
          ...
          <Card className="krds-card">
            <CardContent className="p-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-gray-600">남은 평가</p>
              </div>
            </CardContent>
          </Card>
        </div>
