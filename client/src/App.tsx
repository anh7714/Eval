...
import EvaluatorEvaluation from "@/pages/evaluator/evaluation-fixed";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/evaluator/evaluation" component={EvaluatorEvaluation} />
      <Route path="/evaluator/evaluate/:candidateId" component={EvaluationForm} />
